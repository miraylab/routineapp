...
- Controles internos dos cards de Frente, como `+`, dropdowns, inputs e dialogs, nao devem disparar a navegacao do card. Ao sair de uma pagina de Projeto pelo botao voltar do header, o destino deve ser sempre a pagina de detalhe da Frente correspondente ao `frontId` do projeto.
