...
- Durante o gesto de slideshow, o card deve seguir diretamente a velocidade do dedo/mouse. Ao soltar, a animacao de assentamento deve ser lenta, suave e fluida, completando a troca ou retornando ao centro sem salto brusco; a duracao de referencia atual e 720ms com easing macio `cubic-bezier(0.22,1,0.36,1)`.
...
- O card principal pode ser mais alto que os demais blocos da tela para comportar checklist, detalhes e indicador de bolinhas sem cortar conteudo, mas nao deve crescer alem do necessario. O indicador de bolinhas deve permanecer visivel logo abaixo do ultimo box exibido, com distancia fixa tanto no estado fechado quanto no estado expandido.
